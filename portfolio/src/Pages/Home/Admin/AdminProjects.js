...
function AdminProjects() {
    ...
    var [pType, setType] = React.useState("add");
        ...
        <div>
            ...
            <div className="grid grid-cols-3 gap-5 mt-5">
                {projects.map((project) => (
                    <div className="shadow border p-5 border-gray-400 flex flex-col mt-5 gap-5">
                        <h1 className='text-primary text-xl font-bold'>{project.title}</h1>
                        <img src={project.image} alt="none" className='h-60 w-80' />
